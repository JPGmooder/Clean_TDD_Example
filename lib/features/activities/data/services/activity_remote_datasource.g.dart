...
class _ActivityRemoteDataSourceImpl implements ActivityRemoteDataSourceImpl {
  _ActivityRemoteDataSourceImpl(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<ActivityModel>? getRandomActivityByType(String type) async {
    const _extra = <String, dynamic>{};
